...
class SensorGUI:
    ...
    def open_ph_settings_popup(self):
        ...
        # pH alarm thresholds (preferred layout: checkbox above, min/max side-by-side)
        ...
        ph_range_frame.pack(pady=(5, 10))

        tk.Label(ph_range_frame, text="Min pH:").grid(row=0, column=0, padx=(0, 6), pady=2, sticky="e")
        min_entry = tk.Entry(ph_range_frame, textvariable=min_ph_var, width=10)
        min_entry.grid(row=0, column=1, padx=(0, 14), pady=2)

        tk.Label(ph_range_frame, text="Max pH:").grid(row=0, column=2, padx=(0, 6), pady=2, sticky="e")
    ...
    def open_tds_settings_popup(self):
        ...
        tk.Label(tds_range_frame, text="Min TDS:").grid(row=0, column=0, padx=(0, 6), pady=2, sticky="e")
        min_entry = tk.Entry(tds_range_frame, textvariable=min_tds_var, width=10)
        min_entry.grid(row=0, column=1, padx=(0, 14), pady=2)

        tk.Label(tds_range_frame, text="Max TDS:").grid(row=0, column=2, padx=(0, 6), pady=2, sticky="e")
        ...
        def _on_cond_alarm_toggle():
            if enable_cond_alarm_var.get() and not uScm_var.get():
                messagebox.showinfo("Enable Conductivity Reading",
        ...
        def _on_sal_alarm_toggle():
            if enable_sal_alarm_var.get() and not sal_var.get():
                messagebox.showinfo("Enable Salinity Reading",
