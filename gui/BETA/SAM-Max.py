...
class SensorGUI:
    ...
    def control_pumps(self, sensor_id, water_level_mmwg):
        ...
        if auto_mode:
            ...
            elif water_level_mmwg >= off_threshold:
                # Max level safety shutdown (show warning even in Auto Mode)
    ...
    def open_ph_settings_popup(self):
        ...
        min_label = min_label.grid(row=0, column=0, padx=(0, 6), pady=2, sticky="e")
        min_entry = tk.Entry(ph_range_frame, textvariable=min_ph_var, width=10)
        min_entry.grid(row=0, column=1, padx=(0, 14), pady=2)
        max_label = max_label.grid(row=0, column=2, padx=(0, 6), pady=2, sticky="e")
    ...
    def open_tds_settings_popup(self):
        ...
        def save_tds_settings():
            try:
                ...
                # Ensure all Sensor E settings (including °F toggle) persist
                du.update(settings)
                du["show_fields"] = {
