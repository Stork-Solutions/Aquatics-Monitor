...
class SensorGUI:
    ...
    def attach_water_change_button(self, frame, command):
        ...
        Uses the same emoji/text approach as the settings cog so it renders reliably on your builds.
        """
        btn = tk.Button(
            frame,
            text="💧",
        ...
        # Match the cog's padding; position just to the left of the settings button.
        btn.place(relx=1.0, rely=0.0, anchor="ne", x=-34, y=6)
        return btn
    # Auto GitHub Update
