...
class SensorGUI:
    def __init__(self, root):
        self.root = root
        # GUI Setup
        self.root.title("Stork Aquatics Monitor Max V1.3.3")
        ...
        while self.sensors[sensor_id]["is_running"]:
            try:
                ...
                if sensor_id == "A":
                    ...
                    temperature = serial_port.readline().strip()
                    serial_port.write("RX203\n")
                    water_level = serial_port.readline().strip()
                   ...
                   try:
                       ...
                       ph_level = serial_port.readline().strip()
                       if not ph_level:
                          time.sleep(0.3)
                          serial_port.write("RX205\n")
                          ph_level = serial_port.readline().strip()
