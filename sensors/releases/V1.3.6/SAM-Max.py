# Stork Aquatics Monitor Max V1.3.6
# Wi-Fi TCP - [Enabled]
# 4Ch Relay - [Enabled]
# Pump Override Toggle 10H
# Optional frame Removal
...
class SensorGUI:
    def __init__(self, root):
        self.root = root
        # GUI Setup
        self.root.title("Stork Aquatics Monitor Max V1.3.6")
        ...
        # Main Grid Layout & Names 
        self.aquarium_frame_1 = self.create_sensor_frame("Shark Tank", 0, 0)
        self.aquarium_frame_2 = self.create_sensor_frame("Mini Shrimp Tank", 0, 1)
        self.ro_tank_frame = self.create_ro_tank_frame("RO Tank", 2, 1)
        self.ph_level_frame = self.create_ph_level_frame("pH Sensor", 2, 0)
        self.pump_frame_a = self.create_pump_frame("RO Pump A", 1, 0)
