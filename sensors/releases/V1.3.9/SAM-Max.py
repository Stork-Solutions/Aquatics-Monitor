# Stork Aquatics Monitor Max V1.3.9
# Wi-Fi TCP - [Enabled]
# 4Ch Relay - [Enabled]
# RO System 12h auto power off override - [Enabled]
# Frames Adjustments See Lines 262-270 for grid moving / Frames Hiding 74-82 "True"= Shown "False"= Hidden
...
class SensorGUI:
    def __init__(self, root):
        self.root = root
        # GUI Setup
        self.root.title("Stork Aquatics Monitor Max V1.3.9")
